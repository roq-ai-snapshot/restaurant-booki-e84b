  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.shift_start_time ? format(parseISO(record?.shift_start_time as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'shift_end_time',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.shift_end_time ? format(parseISO(record?.shift_end_time as unknown as string), 'dd-MM-yyyy') : '',
    },
